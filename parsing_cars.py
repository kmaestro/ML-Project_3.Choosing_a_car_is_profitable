...
# print(soup.find('a', class_='e24vrp31').get('href'))
...
r = requests.get('https://moscow.drom.ru/auto/used/all/page101/')

soup = BeautifulSoup(r.text, 'html.parser')
print(soup.find('a', class_='e24vrp31'))
# print(soup.find('a', class_='erw2ohd2').text)
# for link in soup.find_all('a', class_='erw2ohd2'):
#     print(link.get('href'))
...
#         engine = s.text
#     elif span == 'Мощность:':
#         print(re.findall(r"\d{0,3}\s[а-я].[а-я].", s.text)[0])
